...
CREATE TABLE `user_permission` (
  ...
  PRIMARY KEY (`user_iduser`,`permission_idpermission`),
  ...
  CONSTRAINT `user_iduser` FOREIGN KEY (`user_iduser`) REFERENCES `user` (`iduser`)
...
-- Dump completed on 2024-10-16 21:32:17
